...
def get_measurement_timeseries_tvp_observation(self, pk=None):
    """
        Get a MeasurementTimeseriesTVPObservation object
...
def list_monitoring_features(self, **kwargs):
    ...
    if monitoring_feature_list and 'A-Region1' in monitoring_feature_list:
    ...
    if monitoring_feature_list and 'A-1' in monitoring_feature_list:
