...
# -*- coding: utf-8 -*-
#
# BASIN-3D documentation build configuration file, created by
# sphinx-quickstart on Thu Nov  3 09:10:53 2016.
#
...
release = django_basin3d.__version__

# The short X.Y version.
full_version = release.split("-")[0]
version_parts = full_version.split(".")[:-1]
...
intersphinx_mapping = {'python': ('https://docs.python.org/3', None),
                       'basin3d': ('https://basin3d.readthedocs.io/en/latest', None)}
...
html_short_title = 'Django BASIN-3D {}'.format(release)
...
htmlhelp_basename = 'django-basin3d-doc'
...
latex_documents = [
    (master_doc, 'django-basin3d-{}.tex'.format(release), 'Django BASIN-3D Documentation',
     'Charuleka Varadharajan, Valerie Hendrix, Danielle Christianson', 'manual'),
]
...
man_pages = [
    (master_doc, 'basin-3d', 'BASIN-3D Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'django-basin3d', 'Django BASIN-3D Documentation',
     author, 'django-basin3d', 'One line description of project.',
     'Miscellaneous'),
]
